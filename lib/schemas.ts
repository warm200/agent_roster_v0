...
export const ttlPolicySnapshotSchema = z.object({
  ...
  openClawIdleTimeoutMinutes: z.number().int().positive().nullable().optional(),
...
export const runUsageSchema = z.object({
  ...
  lastOpenClawSessionActivityAt: timestampSchema.nullable().optional(),
  lastOpenClawSessionProbeAt: timestampSchema.nullable().optional(),
  openClawSessionCount: z.number().int().nonnegative().nullable().optional(),
  completedAt: timestampSchema.nullable(),
