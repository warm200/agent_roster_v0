...
export const runUsage = pgTable(
  'run_usage',
  {
    ...
    lastOpenClawSessionActivityAt: timestamp('last_openclaw_session_activity_at', { withTimezone: true }),
    lastOpenClawSessionProbeAt: timestamp('last_openclaw_session_probe_at', { withTimezone: true }),
    openClawSessionCount: integer('openclaw_session_count'),
